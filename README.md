...
### 🚀 Fitur Prioritas Demo (5 File Baru)
...
└── user/
    ...
    ├── member_card.php         # Kartu member ⭐
    ├── promo.php               # Promo & voucher ⭐
    └── notification.php        # Notifikasi ⭐


⭐ = Fitur baru prioritas demo
...
- ✅ Telepon format (10-13 digit)
- ✅ Tanggal tidak boleh masa lalu
- ✅ Jam bentrok detection
- ✅ Durasi min 1 jam, max 8 jam
- ✅ Kode promo validation
